...
function correlation_initbump_rt(varargin)
...
for idx_surrogate_run = surrogate_runs
    ...
    if ~ischar(idx_surrogate_loop)
        ...
        y_surrogate = importdata('/Users/marcocolnaghi/PhD/freeze_ddm/model_results/extrema_detection/ac_vs_ed/run03/sims_ed/y.mat');
    ...
    y_surrogate = y_surrogate(y_surrogate.durations_s > d/60 & y_surrogate.durations_s < 11, :);
