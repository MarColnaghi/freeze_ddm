...
all_pdf.ed = @(ts, theta, mu, ndt, fs) ed_vectorized_trials_log(ts - ndt, theta, mu, fs, 'pdf');
all_cdf.ed = @(ts, theta, mu, ndt, fs) ed_vectorized_trials_log(ts - ndt, theta, mu, fs, 'cdf');
