...
model_2_fit = 'ed9';
model_results = run_fitting_newer(bouts_proc, points, model_2_fit, paths, 'export', true,  'ground_truth', gt_table, 'bads_display', false, 'pass_ndt', false, 'n_bads', 3, 'extra', extra);
