...
model_results = run_fitting_newer(bouts_proc, points, 'dddm20', paths, 'export', true, 'bads_display', true, 'pass_ndt', false, 'n_bads', 1, 'extra', extra, 'vbmc_exhaustive', false);
