...
model_results = run_fitting_newer(bouts_proc, points, 'sddmtv11', paths, 'export', true, 'bads_display', true, 'pass_ndt', false, 'n_bads', 5, 'extra', extra, 'vbmc_exhaustive', false);
